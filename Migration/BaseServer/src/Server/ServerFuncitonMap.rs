...
pub fn ServerAction_CHAT_MESSAGE_TO_ONE(server: &mut ServerBase, val : String) -> i64 {
    println!("Message Test 2 {}",  val);
    0
}

pub fn ServerAction_CHAT_MESSAGE_TO_GROUP(server: &mut ServerBase, val : String) -> i64 {
